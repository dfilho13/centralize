            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 mb-5">Cadastro de pacientes</h1>
                        <div class="card mb-4">
                            <form action="pesquisa-paciente.php" method="GET">
                                ...
                                <div class="container mt-5">
                                    ...
                                    ?>
                                        <div class="col-lg-3 col-md-4 col-sm-6 mt-5 mr-5">
                                            <a href="view-paciente.php?cod=<?=$dados['cod_paciente']?>" style="color:inherit">
                                                <div class="card" style="width: 18rem;" id="exib">
                                                    ...
                                                    <div class="card-body">
                                                        <h5 class="card-title mt-3"><?=$dados['nom_paciente']?></h5>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="php/cadastrar-paciente.php" method="POST">
                            <div class="row">
                                <div class="input-group mt-3">
                                    <input type="text" class="form-control" placeholder="Nome" name="nom_paciente" required="">
                                </div>
                                <div class="input-group mt-3">
